...
class ServerReflection final {
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void ServerReflectionInfo(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::grpc::reflection::v1alpha::ServerReflectionRequest,::grpc::reflection::v1alpha::ServerReflectionResponse>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void ServerReflectionInfo(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::grpc::reflection::v1alpha::ServerReflectionRequest,::grpc::reflection::v1alpha::ServerReflectionResponse>* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_ServerReflectionInfo : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_ServerReflectionInfo() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackBidiHandler< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context) { return this->ServerReflectionInfo(context); }));
    }
    ~ExperimentalWithCallbackMethod_ServerReflectionInfo() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ServerReflectionInfo(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::grpc::reflection::v1alpha::ServerReflectionResponse, ::grpc::reflection::v1alpha::ServerReflectionRequest>* /*stream*/)  override {
    ...
    #else
    virtual ::grpc::experimental::ServerBidiReactor< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>* ServerReflectionInfo(
      ::grpc::experimental::CallbackServerContext* /*context*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_ServerReflectionInfo<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_ServerReflectionInfo<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_ServerReflectionInfo : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_ServerReflectionInfo() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
    ...
    ~ExperimentalWithRawCallbackMethod_ServerReflectionInfo() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ServerReflectionInfo(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::grpc::reflection::v1alpha::ServerReflectionResponse, ::grpc::reflection::v1alpha::ServerReflectionRequest>* /*stream*/)  override {
    ...
    virtual ::grpc::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* ServerReflectionInfo(
      ::grpc::CallbackServerContext* /*context*/)
    #else
    virtual ::grpc::experimental::ServerBidiReactor< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* ServerReflectionInfo(
      ::grpc::experimental::CallbackServerContext* /*context*/)
    #endif
      { return nullptr; }
  };
