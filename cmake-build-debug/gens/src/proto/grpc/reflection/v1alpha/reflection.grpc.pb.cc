...
ServerReflection::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_ServerReflectionInfo_(ServerReflection_method_names[0], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
::grpc::ClientReaderWriter< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>* ServerReflection::Stub::ServerReflectionInfoRaw(::grpc::ClientContext* context) {
  return ::grpc_impl::internal::ClientReaderWriterFactory< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>::Create(channel_.get(), rpcmethod_ServerReflectionInfo_, context);
}

void ServerReflection::Stub::experimental_async::ServerReflectionInfo(::grpc::ClientContext* context, ::grpc::experimental::ClientBidiReactor< ::grpc::reflection::v1alpha::ServerReflectionRequest,::grpc::reflection::v1alpha::ServerReflectionResponse>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderWriterFactory< ::grpc::reflection::v1alpha::ServerReflectionRequest,::grpc::reflection::v1alpha::ServerReflectionResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_ServerReflectionInfo_, context, reactor);
}
...
::grpc::ClientAsyncReaderWriter< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>* ServerReflection::Stub::AsyncServerReflectionInfoRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderWriterFactory< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>::Create(channel_.get(), cq, rpcmethod_ServerReflectionInfo_, context, true, tag);
}
...
::grpc::ClientAsyncReaderWriter< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>* ServerReflection::Stub::PrepareAsyncServerReflectionInfoRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderWriterFactory< ::grpc::reflection::v1alpha::ServerReflectionRequest, ::grpc::reflection::v1alpha::ServerReflectionResponse>::Create(channel_.get(), cq, rpcmethod_ServerReflectionInfo_, context, false, nullptr);
}
