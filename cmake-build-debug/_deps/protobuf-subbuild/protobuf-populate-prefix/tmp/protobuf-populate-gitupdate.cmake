...
execute_process(
  COMMAND "/usr/bin/git" show-ref v3.11.4
  WORKING_DIRECTORY "/home/ibrahim/Hazel/HazelKV/cmake-build-debug/_deps/protobuf-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v3.11.4")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v3.11.4")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v3.11.4
  WORKING_DIRECTORY "/home/ibrahim/Hazel/HazelKV/cmake-build-debug/_deps/protobuf-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/protocolbuffers/protobuf'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ibrahim/Hazel/HazelKV/cmake-build-debug/_deps/protobuf-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ibrahim/Hazel/HazelKV/cmake-build-debug/_deps/protobuf-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
